...
static CGFloat CRLINE_WIDTH = 1.f;
static CGFloat CR_EXTRALINE_WIDTH = 0.25f;
static CGFloat CR_POINTS_R_INNER = 6.f;
static CGFloat CR_POINTS_R_OUTTER = 6.f;
static CGFloat CR_EXTRALINE_ADD = 8.f;

//static CGFloat CR_POINTS_R_INNER = 8.f;
//static CGFloat CR_POINTS_R_OUTTER = 8.f;
//static CGFloat CR_EXTRALINE_ADD = 8.f;

//实线
static CGFloat dashedPattern[] = {0,0};
