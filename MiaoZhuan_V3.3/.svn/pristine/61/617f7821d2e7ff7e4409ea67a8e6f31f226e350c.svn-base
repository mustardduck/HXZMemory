...
- (void) createLogoBar
{
    RTLabel * logoTextLbl = [[RTLabel alloc] init];
    
    logoTextLbl.frame = CGRectMake(W(self.view) - 140, H(self.view) - 50, 100, 26);
    logoTextLbl.textAlignment = RTTextAlignmentRight;
    logoTextLbl.textColor = [UIColor whiteColor];
    logoTextLbl.font = Font(22);
    logoTextLbl.text = @"秒赚";
    
    [self.view addSubview:logoTextLbl];
}
