...
- (void)haha{
    ...
    for (int i = 0; i<_dataArray.count; i++) {
        ...
        if (!pictureUrlStr.length || [pictureUrlStr isKindOfClass:[NSNull class]]) {
            ...
            UIImageView *imgview = [UICommon getIos4OffsetY] ? [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"iphone5.png"]] autorelease] : [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"iphone4.png"]] autorelease];
