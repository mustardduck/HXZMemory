...
@interface SCNavTabBar () <SCPopViewDelegate>
{
    ...
    UIButton        *_buttonSelected;       //selected button  //cena
    UIView          *_lineBottom;           //bottom line
}
...
- (void)viewConfig
{
    ...
    if (_lineBottom == nil) {
        _lineBottom = [[UIView alloc] initWithFrame:CGRectMake(0, NAVIGATION_BAR_HEIGHT - 0.5, SCREEN_WIDTH, 0.5)];
        _lineBottom.backgroundColor = RGBCOLOR(204, 204, 204);
...
{
    _line = [[UIView alloc] initWithFrame:CGRectMake(45.0f, NAV_TAB_BAR_HEIGHT - 2.0f, width - 90.0f, 2.0f)];
    _line.backgroundColor = UIColorWithRGBA(240.0f, 5.0f, 0.0f, 1.0f);
...
- (CGFloat)contentWidthAndAddNavTabBarItemsWithButtonsWidth:(NSArray *)widths
{
    ...
    for (NSInteger index = 0; index < [_itemTitles count]; index++)
    {
        ...
        [button setTitleColor:UIColorWithRGBA(34, 34, 34, 1) forState:UIControlStateNormal];
    ...
    _buttonSelected = _items[0];
    [_buttonSelected setTitleColor:UIColorWithRGBA(240, 5, 0, 1) forState:UIControlStateNormal];
    _buttonSelected.titleLabel.font = [UIFont systemFontOfSize:16];
...
{
    [_buttonSelected setTitleColor:UIColorWithRGBA(34, 34, 34, 1) forState:UIControlStateNormal];
    _buttonSelected.titleLabel.font = [UIFont systemFontOfSize:14];
...
- (void)setCurrentItemIndex:(NSInteger)currentItemIndex
{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        _line.frame = CGRectMake(button.frame.origin.x + 45.0f, _line.frame.origin.y, [_itemsWidth[currentItemIndex] floatValue] - 90.0f, _line.frame.size.height);
    }];
}
