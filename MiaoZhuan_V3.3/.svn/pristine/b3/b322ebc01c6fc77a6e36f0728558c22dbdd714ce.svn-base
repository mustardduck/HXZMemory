...
@interface StartApealViewController ()<UITextViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIGestureRecognizerDelegate>{
...
@property (retain, nonatomic) IBOutlet UITextView *mainTextView;
...
@implementation StartApealViewController
...
- (IBAction) onMoveFoward:(UIButton*) sender {
    ...
    [postData set:@"Reason" string:_theReasonMerchantDisagreeReturn];
    ...
    [postData set:@"Pictures" value:idsArray];
    
    if ([_theReasonMerchantDisagreeReturn isEqualToString:@""] || !_theReasonMerchantDisagreeReturn) {
        
        [HUDUtil showErrorWithStatus:@"请输入完整信息"];
        return;
    }
    ADAPI_MercahntStartApealing([self genDelegatorID:@selector(postData:)],postData.dictionary);
}
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text {
    ...
    self.theReasonMerchantDisagreeReturn = aString;
