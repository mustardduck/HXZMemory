...
- (IBAction)doneAction:(id)sender
{
    ...
    CGFloat maxSize;
    if (SCREENHEIGHT > 500) maxSize = 290.f; else maxSize = 260.f;
    __block CGFloat myScale = self.outputWidth > maxSize ? (self.outputWidth/maxSize):1.0;
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            UIImage *transform =  [UIImage imageWithCGImage:resultRef scale:myScale orientation:UIImageOrientationUp];
