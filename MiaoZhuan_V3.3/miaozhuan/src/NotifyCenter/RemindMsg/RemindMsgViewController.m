...
@interface RemindMsgViewController ()<UITableViewDataSource,UITableViewDelegate,cr_SegHeaderDelegate,cr_NCCellDelegate>
{
...
- (void)configureTableView
{
    ...
    NSString * refreshName = @"Message/PhoneVerifyMsg";
    _MJRefreshCon = [MJRefreshController controllerFrom:_tableView name:refreshName];
    
    __block RemindMsgViewController *weakself = self;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return 100 + (cell.exFloat>0?cell.exFloat + 10.f:0) + 9.5;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        UIView* view1 = WEAK_OBJECT(UIView, initWithFrame:CGRectMake(0, 100 + (cell.exFloat>0?cell.exFloat + 10.f:0) + 11, 320, 0.5));
