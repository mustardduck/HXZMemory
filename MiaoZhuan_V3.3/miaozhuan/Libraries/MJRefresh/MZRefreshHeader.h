...
typedef enum {
    /** 普通闲置状态 */
    MZRefreshHeaderStateIdle = 1,
    /** 松开就可以进行刷新的状态 */
    MZRefreshHeaderStatePulling,
    /** 正在刷新中的状态 */
    MZRefreshHeaderStateRefreshing,
    /** 即将刷新的状态 */
    MZRefreshHeaderStateWillRefresh
} MZRefreshHeaderState;
...
/** 刷新控件的状态 */
@property (assign, nonatomic) MZRefreshHeaderState state;
