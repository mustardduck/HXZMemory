...
typedef enum {
    MZRefreshFooterStateIdle = 1, // 普通闲置状态
    MZRefreshFooterStateRefreshing, // 正在刷新中的状态
    MZRefreshFooterStateNoMoreData // 所有数据加载完毕，没有更多的数据了
} MZRefreshFooterState;
...
/** 刷新控件的状态(交给子类重写) */
@property (assign, nonatomic) MZRefreshFooterState state;
