...
extern NSString* OPTION_NEED_LOADING_INDICATOR_COVER;
...
@interface ServerRequestOption : NSObject<NSCopying>
...
- (void) setDelegatorID:(DelegatorID)delegatorID;
...
@interface NetService : EventEmitter

- (ServerRequest*) doRequest:(NSString*)operation forModule:(NSString*)module withOption:(ServerRequestOption*)option;
...
#define NET_SERVICE [NetService instance]
